...
CmdletsToExport = @('Read-PbiReport' ,'Switch-PbiReportDataSource' ,'Write-PbiReport' ,'Export-TabularModelDataSources' ,'Find-TabularModelDaxErrors' ,'Import-TabularModelDataSources' ,'Read-TabularModel' ,'Register-TabularModelMExpressions' ,'Register-TabularModelDataSources' ,'Remove-TabularModelAutoTimeIntelligence' ,'Remove-TabularModelCultures' ,'Resolve-TabularModelPasswords' ,'Switch-TabularModelCompatibilityLevel' ,'Write-TabularModel' ,'Compress-PbiReport' ,'Expand-PbiReport' ,'Compress-PbiReport' ,'Expand-PbiReport' ,'Export-TabularModelDataSources' ,'Find-TabularModelDaxErrors' ,'Import-TabularModelDataSources' ,'Read-PbiReport' ,'Read-TabularModel' ,'Register-TabularModelDataSources' ,'Register-TabularModelMExpressions' ,'Remove-TabularModelAutoTimeIntelligence' ,'Remove-TabularModelCultures' ,'Resolve-TabularModelPasswords' ,'Switch-PbiReportDataSource' ,'Switch-TabularModelCompatibilityLevel' ,'Write-PbiReport' ,'Write-TabularModel', 'Test-PbiReportDataModelReferences', 'Switch-PbiReportDataModelReference')
